...
void OpenAPIGrantCollectionRoleRequest::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIGrantCollectionRoleRequest::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
