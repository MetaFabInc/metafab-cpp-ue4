...
void OpenAPIApproveEcosystemGameRequest::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIApproveEcosystemGameRequest::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
