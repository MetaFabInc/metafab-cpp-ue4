...
void OpenAPIWithdrawFromExchangeRequest::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIWithdrawFromExchangeRequest::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
