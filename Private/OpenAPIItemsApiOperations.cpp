...
void OpenAPIItemsApi::BatchMintCollectionItemsRequest::SetupHttpRequest(const FHttpRequestRef& HttpRequest) const
{
	...
	{
		UE_LOG(LogMetaFab, Error, TEXT("Body parameter (OpenAPIBatchMintCollectionItemsRequest) was ignored, not supported in multipart form"));
	}
	else if (Consumes.Contains(TEXT("application/x-www-form-urlencoded")))
	{
		UE_LOG(LogMetaFab, Error, TEXT("Body parameter (OpenAPIBatchMintCollectionItemsRequest) was ignored, not supported in urlencoded requests"));
	}
	else
	{
...
void OpenAPIItemsApi::BatchTransferCollectionItemsRequest::SetupHttpRequest(const FHttpRequestRef& HttpRequest) const
{
	...
	{
		UE_LOG(LogMetaFab, Error, TEXT("Body parameter (OpenAPIBatchTransferCollectionItemsRequest) was ignored, not supported in multipart form"));
	}
	else if (Consumes.Contains(TEXT("application/x-www-form-urlencoded")))
	{
		UE_LOG(LogMetaFab, Error, TEXT("Body parameter (OpenAPIBatchTransferCollectionItemsRequest) was ignored, not supported in urlencoded requests"));
	}
	else
	{
		UE_LOG(LogMetaFab, Error, TEXT("Request ContentType not supported (%s)"), *FString::Join(Consumes, TEXT(",")));
...
void OpenAPIItemsApi::BurnCollectionItemRequest::SetupHttpRequest(const FHttpRequestRef& HttpRequest) const
{
	...
	{
		UE_LOG(LogMetaFab, Error, TEXT("Body parameter (OpenAPIBurnCollectionItemRequest) was ignored, not supported in multipart form"));
	}
	else if (Consumes.Contains(TEXT("application/x-www-form-urlencoded")))
	{
		UE_LOG(LogMetaFab, Error, TEXT("Body parameter (OpenAPIBurnCollectionItemRequest) was ignored, not supported in urlencoded requests"));
	}
	else
	{
		UE_LOG(LogMetaFab, Error, TEXT("Request ContentType not supported (%s)"), *FString::Join(Consumes, TEXT(",")));
...
void OpenAPIItemsApi::CreateCollectionRequest::SetupHttpRequest(const FHttpRequestRef& HttpRequest) const
{
	...
	{
		UE_LOG(LogMetaFab, Error, TEXT("Body parameter (OpenAPICreateCollectionRequest) was ignored, not supported in multipart form"));
	}
	else if (Consumes.Contains(TEXT("application/x-www-form-urlencoded")))
	{
		UE_LOG(LogMetaFab, Error, TEXT("Body parameter (OpenAPICreateCollectionRequest) was ignored, not supported in urlencoded requests"));
	}
	else
	{
		UE_LOG(LogMetaFab, Error, TEXT("Request ContentType not supported (%s)"), *FString::Join(Consumes, TEXT(",")));
...
void OpenAPIItemsApi::CreateCollectionItemRequest::SetupHttpRequest(const FHttpRequestRef& HttpRequest) const
{
	...
	{
		UE_LOG(LogMetaFab, Error, TEXT("Body parameter (OpenAPICreateCollectionItemRequest) was ignored, not supported in multipart form"));
	}
	else if (Consumes.Contains(TEXT("application/x-www-form-urlencoded")))
	{
		UE_LOG(LogMetaFab, Error, TEXT("Body parameter (OpenAPICreateCollectionItemRequest) was ignored, not supported in urlencoded requests"));
	}
	else
	{
		UE_LOG(LogMetaFab, Error, TEXT("Request ContentType not supported (%s)"), *FString::Join(Consumes, TEXT(",")));
...
void OpenAPIItemsApi::GrantCollectionRoleRequest::SetupHttpRequest(const FHttpRequestRef& HttpRequest) const
{
	...
	{
		UE_LOG(LogMetaFab, Error, TEXT("Body parameter (OpenAPIGrantCollectionRoleRequest) was ignored, not supported in multipart form"));
	}
	else if (Consumes.Contains(TEXT("application/x-www-form-urlencoded")))
	{
		UE_LOG(LogMetaFab, Error, TEXT("Body parameter (OpenAPIGrantCollectionRoleRequest) was ignored, not supported in urlencoded requests"));
	}
	else
	{
		UE_LOG(LogMetaFab, Error, TEXT("Request ContentType not supported (%s)"), *FString::Join(Consumes, TEXT(",")));
...
void OpenAPIItemsApi::MintCollectionItemRequest::SetupHttpRequest(const FHttpRequestRef& HttpRequest) const
{
	...
	{
		UE_LOG(LogMetaFab, Error, TEXT("Body parameter (OpenAPIMintCollectionItemRequest) was ignored, not supported in multipart form"));
	}
	else if (Consumes.Contains(TEXT("application/x-www-form-urlencoded")))
	{
		UE_LOG(LogMetaFab, Error, TEXT("Body parameter (OpenAPIMintCollectionItemRequest) was ignored, not supported in urlencoded requests"));
	}
	else
	{
		UE_LOG(LogMetaFab, Error, TEXT("Request ContentType not supported (%s)"), *FString::Join(Consumes, TEXT(",")));
...
void OpenAPIItemsApi::SetCollectionApprovalRequest::SetupHttpRequest(const FHttpRequestRef& HttpRequest) const
{
	...
	{
		UE_LOG(LogMetaFab, Error, TEXT("Body parameter (OpenAPISetCollectionApprovalRequest) was ignored, not supported in multipart form"));
	}
	else if (Consumes.Contains(TEXT("application/x-www-form-urlencoded")))
	{
		UE_LOG(LogMetaFab, Error, TEXT("Body parameter (OpenAPISetCollectionApprovalRequest) was ignored, not supported in urlencoded requests"));
	}
	else
	{
		UE_LOG(LogMetaFab, Error, TEXT("Request ContentType not supported (%s)"), *FString::Join(Consumes, TEXT(",")));
...
void OpenAPIItemsApi::SetCollectionItemTimelockRequest::SetupHttpRequest(const FHttpRequestRef& HttpRequest) const
{
	...
	{
		UE_LOG(LogMetaFab, Error, TEXT("Body parameter (OpenAPISetCollectionItemTimelockRequest) was ignored, not supported in multipart form"));
	}
	else if (Consumes.Contains(TEXT("application/x-www-form-urlencoded")))
	{
		UE_LOG(LogMetaFab, Error, TEXT("Body parameter (OpenAPISetCollectionItemTimelockRequest) was ignored, not supported in urlencoded requests"));
	}
	else
	{
		UE_LOG(LogMetaFab, Error, TEXT("Request ContentType not supported (%s)"), *FString::Join(Consumes, TEXT(",")));
...
void OpenAPIItemsApi::TransferCollectionItemRequest::SetupHttpRequest(const FHttpRequestRef& HttpRequest) const
{
	...
	{
		UE_LOG(LogMetaFab, Error, TEXT("Body parameter (OpenAPITransferCollectionItemRequest) was ignored, not supported in multipart form"));
	}
	else if (Consumes.Contains(TEXT("application/x-www-form-urlencoded")))
	{
		UE_LOG(LogMetaFab, Error, TEXT("Body parameter (OpenAPITransferCollectionItemRequest) was ignored, not supported in urlencoded requests"));
	}
	else
	{
		UE_LOG(LogMetaFab, Error, TEXT("Request ContentType not supported (%s)"), *FString::Join(Consumes, TEXT(",")));
