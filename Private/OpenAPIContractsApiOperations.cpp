...
void OpenAPIContractsApi::CreateContractRequest::SetupHttpRequest(const FHttpRequestRef& HttpRequest) const
{
	...
	{
		UE_LOG(LogMetaFab, Error, TEXT("Body parameter (OpenAPICreateContractRequest) was ignored, not supported in multipart form"));
	}
	else if (Consumes.Contains(TEXT("application/x-www-form-urlencoded")))
	{
		UE_LOG(LogMetaFab, Error, TEXT("Body parameter (OpenAPICreateContractRequest) was ignored, not supported in urlencoded requests"));
	}
	else
	{
...
void OpenAPIContractsApi::WriteContractRequest::SetupHttpRequest(const FHttpRequestRef& HttpRequest) const
{
	...
	{
		UE_LOG(LogMetaFab, Error, TEXT("Body parameter (OpenAPIWriteContractRequest) was ignored, not supported in multipart form"));
	}
	else if (Consumes.Contains(TEXT("application/x-www-form-urlencoded")))
	{
		UE_LOG(LogMetaFab, Error, TEXT("Body parameter (OpenAPIWriteContractRequest) was ignored, not supported in urlencoded requests"));
	}
	else
	{
		UE_LOG(LogMetaFab, Error, TEXT("Request ContentType not supported (%s)"), *FString::Join(Consumes, TEXT(",")));
