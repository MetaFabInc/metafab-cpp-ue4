...
void OpenAPIUpdateProfilePlayerRequest::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIUpdateProfilePlayerRequest::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
