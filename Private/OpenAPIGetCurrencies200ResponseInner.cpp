...
void OpenAPIGetCurrencies200ResponseInner::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIGetCurrencies200ResponseInner::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
