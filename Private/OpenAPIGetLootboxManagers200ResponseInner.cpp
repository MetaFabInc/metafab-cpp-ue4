...
void OpenAPIGetLootboxManagers200ResponseInner::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIGetLootboxManagers200ResponseInner::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
