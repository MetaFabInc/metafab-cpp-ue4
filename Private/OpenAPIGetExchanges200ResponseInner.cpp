...
void OpenAPIGetExchanges200ResponseInner::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIGetExchanges200ResponseInner::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
