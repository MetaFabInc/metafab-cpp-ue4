...
#include "OpenAPICurrencyModel.h"
...
void OpenAPICurrencyModel::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPICurrencyModel::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
