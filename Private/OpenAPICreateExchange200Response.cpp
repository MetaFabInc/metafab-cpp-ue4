...
void OpenAPICreateExchange200Response::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPICreateExchange200Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
