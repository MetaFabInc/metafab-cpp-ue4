...
#include "OpenAPILootboxManagerModel.h"
...
void OpenAPILootboxManagerModel::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPILootboxManagerModel::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
