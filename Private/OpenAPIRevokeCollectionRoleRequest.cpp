...
void OpenAPIRevokeCollectionRoleRequest::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIRevokeCollectionRoleRequest::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
