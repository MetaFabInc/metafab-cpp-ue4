...
#include "OpenAPIExchangeModel.h"
...
void OpenAPIExchangeModel::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIExchangeModel::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
