...
void OpenAPIBatchMintCollectionItemsRequest::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIBatchMintCollectionItemsRequest::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
