...
void OpenAPICreateProfilePlayerRequest::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPICreateProfilePlayerRequest::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
