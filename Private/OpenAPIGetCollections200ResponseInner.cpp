...
void OpenAPIGetCollections200ResponseInner::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIGetCollections200ResponseInner::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
