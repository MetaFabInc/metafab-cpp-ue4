...
void OpenAPIPlayersApi::CreatePlayerRequest::SetupHttpRequest(const FHttpRequestRef& HttpRequest) const
{
	...
	{
		UE_LOG(LogMetaFab, Error, TEXT("Body parameter (OpenAPICreatePlayerRequest) was ignored, not supported in multipart form"));
	}
	else if (Consumes.Contains(TEXT("application/x-www-form-urlencoded")))
	{
		UE_LOG(LogMetaFab, Error, TEXT("Body parameter (OpenAPICreatePlayerRequest) was ignored, not supported in urlencoded requests"));
	}
	else
	{
...
void OpenAPIPlayersApi::SetPlayerDataRequest::SetupHttpRequest(const FHttpRequestRef& HttpRequest) const
{
	...
	{
		UE_LOG(LogMetaFab, Error, TEXT("Body parameter (OpenAPISetPlayerDataRequest) was ignored, not supported in multipart form"));
	}
	else if (Consumes.Contains(TEXT("application/x-www-form-urlencoded")))
	{
		UE_LOG(LogMetaFab, Error, TEXT("Body parameter (OpenAPISetPlayerDataRequest) was ignored, not supported in urlencoded requests"));
	}
	else
	{
		UE_LOG(LogMetaFab, Error, TEXT("Request ContentType not supported (%s)"), *FString::Join(Consumes, TEXT(",")));
...
void OpenAPIPlayersApi::UpdatePlayerRequest::SetupHttpRequest(const FHttpRequestRef& HttpRequest) const
{
	...
	{
		UE_LOG(LogMetaFab, Error, TEXT("Body parameter (OpenAPIUpdatePlayerRequest) was ignored, not supported in multipart form"));
	}
	else if (Consumes.Contains(TEXT("application/x-www-form-urlencoded")))
	{
		UE_LOG(LogMetaFab, Error, TEXT("Body parameter (OpenAPIUpdatePlayerRequest) was ignored, not supported in urlencoded requests"));
	}
	else
	{
		UE_LOG(LogMetaFab, Error, TEXT("Request ContentType not supported (%s)"), *FString::Join(Consumes, TEXT(",")));
