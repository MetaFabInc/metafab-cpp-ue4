...
void OpenAPISetExchangeOfferRequest::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPISetExchangeOfferRequest::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
