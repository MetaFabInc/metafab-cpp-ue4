...
#include "OpenAPIPublicProfile.h"
...
void OpenAPIPublicProfile::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIPublicProfile::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
