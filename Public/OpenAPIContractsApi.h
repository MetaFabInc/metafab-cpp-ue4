...
class OPENAPI_API OpenAPIContractsApi
{
public:
	OpenAPIContractsApi();
	~OpenAPIContractsApi();
	...
	* See also: Request::SetShouldRetry */
	...
	class TransferContractOwnershipResponse;
	class UpgradeContractTrustedForwarderRequest;
	class UpgradeContractTrustedForwarderResponse;
    ...
    DECLARE_DELEGATE_OneParam(FTransferContractOwnershipDelegate, const TransferContractOwnershipResponse&);
    DECLARE_DELEGATE_OneParam(FUpgradeContractTrustedForwarderDelegate, const UpgradeContractTrustedForwarderResponse&);
    ...
    FHttpRequestPtr TransferContractOwnership(const TransferContractOwnershipRequest& Request, const FTransferContractOwnershipDelegate& Delegate = FTransferContractOwnershipDelegate()) const;
    FHttpRequestPtr UpgradeContractTrustedForwarder(const UpgradeContractTrustedForwarderRequest& Request, const FUpgradeContractTrustedForwarderDelegate& Delegate = FUpgradeContractTrustedForwarderDelegate()) const;
...
private:
    ...
    void OnTransferContractOwnershipResponse(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FTransferContractOwnershipDelegate Delegate) const;
    void OnUpgradeContractTrustedForwarderResponse(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FUpgradeContractTrustedForwarderDelegate Delegate) const;
