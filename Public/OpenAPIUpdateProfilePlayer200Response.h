...
/*
 * OpenAPIUpdateProfilePlayer200Response
 *
 * 
 */
class OPENAPI_API OpenAPIUpdateProfilePlayer200Response : public Model
{
public:
    virtual ~OpenAPIUpdateProfilePlayer200Response() {}
