...
/*
 * OpenAPIGetLootboxManagers200ResponseInner
 *
 * 
 */
class OPENAPI_API OpenAPIGetLootboxManagers200ResponseInner : public Model
{
public:
    virtual ~OpenAPIGetLootboxManagers200ResponseInner() {}
