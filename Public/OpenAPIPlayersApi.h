...
class OPENAPI_API OpenAPIPlayersApi
{
public:
	OpenAPIPlayersApi();
	~OpenAPIPlayersApi();
	...
	* See also: Request::SetShouldRetry */
	...
	class RemovePlayerConnectedWalletResponse;
	class SetPlayerConnectedWalletRequest;
	class SetPlayerConnectedWalletResponse;
    ...
    DECLARE_DELEGATE_OneParam(FRemovePlayerConnectedWalletDelegate, const RemovePlayerConnectedWalletResponse&);
    DECLARE_DELEGATE_OneParam(FSetPlayerConnectedWalletDelegate, const SetPlayerConnectedWalletResponse&);
    ...
    FHttpRequestPtr RemovePlayerConnectedWallet(const RemovePlayerConnectedWalletRequest& Request, const FRemovePlayerConnectedWalletDelegate& Delegate = FRemovePlayerConnectedWalletDelegate()) const;
    FHttpRequestPtr SetPlayerConnectedWallet(const SetPlayerConnectedWalletRequest& Request, const FSetPlayerConnectedWalletDelegate& Delegate = FSetPlayerConnectedWalletDelegate()) const;
...
private:
    ...
    void OnRemovePlayerConnectedWalletResponse(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FRemovePlayerConnectedWalletDelegate Delegate) const;
    void OnSetPlayerConnectedWalletResponse(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FSetPlayerConnectedWalletDelegate Delegate) const;
