...
*/
class METAFAB_API OpenAPITransactionsApi::GetTransactionRequest : public Request
{
public:
...
class METAFAB_API OpenAPITransactionsApi::GetTransactionResponse : public Response
{
public:
