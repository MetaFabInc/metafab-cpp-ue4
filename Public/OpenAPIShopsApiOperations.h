...
*/
class OPENAPI_API OpenAPIShopsApi::CreateShopRequest : public Request
{
public:
...
class OPENAPI_API OpenAPIShopsApi::CreateShopResponse : public Response
{
public:
...
*/
class OPENAPI_API OpenAPIShopsApi::GetShopOfferRequest : public Request
{
public:
	...
	/* Any shop id within the MetaFab platform. */
	FString ShopId;
	/* Any offer id for the shop. Zero, or a positive integer. */
	FString ShopOfferId;
};

class OPENAPI_API OpenAPIShopsApi::GetShopOfferResponse : public Response
{
public:
...
*/
class OPENAPI_API OpenAPIShopsApi::GetShopOffersRequest : public Request
{
public:
...
class OPENAPI_API OpenAPIShopsApi::GetShopOffersResponse : public Response
{
public:
...
*/
class OPENAPI_API OpenAPIShopsApi::GetShopsRequest : public Request
{
public:
...
class OPENAPI_API OpenAPIShopsApi::GetShopsResponse : public Response
{
public:
...
*/
class OPENAPI_API OpenAPIShopsApi::RemoveShopOfferRequest : public Request
{
public:
...
class OPENAPI_API OpenAPIShopsApi::RemoveShopOfferResponse : public Response
{
public:
...
*/
class OPENAPI_API OpenAPIShopsApi::SetShopOfferRequest : public Request
{
public:
...
class OPENAPI_API OpenAPIShopsApi::SetShopOfferResponse : public Response
{
public:
...
*/
class OPENAPI_API OpenAPIShopsApi::UseShopOfferRequest : public Request
{
public:
...
class OPENAPI_API OpenAPIShopsApi::UseShopOfferResponse : public Response
{
public:
...
*/
class OPENAPI_API OpenAPIShopsApi::WithdrawFromShopRequest : public Request
{
public:
...
class OPENAPI_API OpenAPIShopsApi::WithdrawFromShopResponse : public Response
{
public:
