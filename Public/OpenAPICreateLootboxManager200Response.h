...
/*
 * OpenAPICreateLootboxManager200Response
 *
 * 
 */
class OPENAPI_API OpenAPICreateLootboxManager200Response : public Model
{
public:
    virtual ~OpenAPICreateLootboxManager200Response() {}
